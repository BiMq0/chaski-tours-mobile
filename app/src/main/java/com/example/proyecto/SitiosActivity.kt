...
import com.example.proyecto.databinding.ActivitySitiosBinding
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import retrofit2.Retrofit
import retrofit2.converter.gson.GsonConverterFactory

class SitiosActivity : AppCompatActivity() {

    private var  lst_sitios: List<ItemSitio> = emptyList()
    private lateinit var binding: ActivitySitiosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivitySitiosBinding.inflate(layoutInflater)
    ...
    private fun getSitios(){
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                ...
                binding.root.layoutManager = LinearLayoutManager(this@SitiosActivity)
